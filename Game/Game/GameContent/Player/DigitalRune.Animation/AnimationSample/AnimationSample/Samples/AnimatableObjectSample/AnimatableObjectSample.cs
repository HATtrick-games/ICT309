...
namespace AnimationSample
{
  ...
  // 3 sprites are displayed. The color of the second sprite is animated. The color
  // and the position of the third sprite are animated.
  public class AnimatableObjectSample : Sample
  {
    private AnimatableSprite _animatableSpriteA;
    private AnimatableSprite _animatableSpriteB;
    private AnimatableSprite _animatableSpriteC;


    public AnimatableObjectSample(Game game)
      : base(game)
    {
      DisplayMessage = "AnimatableObjectSample\n"
                     + "This sample shows how to use IAnimatableObjects. The sprite classes implement this interface.\n"
                     + "The Color of the second sprite and the Color and the Position of the third sprite are animated.";
    }
    ...
    protected override void LoadContent()
    {
      ...
      // For example: 
      AnimationService.StartAnimation(allSpriteAnimations, new[] { _animatableSpriteA, _animatableSpriteB, _animatableSpriteC });
      // The "TargetObject" and "TargetPropery" values are used to check which objects and

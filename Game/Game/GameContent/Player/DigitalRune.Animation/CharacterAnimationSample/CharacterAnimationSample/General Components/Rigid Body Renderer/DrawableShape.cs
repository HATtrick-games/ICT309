...
namespace CharacterAnimationSample
{
  ...
  public class DrawableShape
  {
    ...
    // True if the shape is double-sided triangle mesh.
    ...
    public void LoadContent(GraphicsDevice graphicsDevice, IGeometricObject geometricObject)
    {
      ...
      // Check if the shape is a two-sided triangle mesh.
      TriangleMeshShape triangleMeshShape = geometricObject.Shape as TriangleMeshShape;
      IsTwoSided = (triangleMeshShape != null && triangleMeshShape.IsTwoSided);
    }

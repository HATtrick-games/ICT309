    ...
    class MainGameHUD : UIScreen
    {
        ...
        protected override void OnUpdate(TimeSpan deltaTime)
        {
            ...
            for (int i = 0; i < _healthBars.Count; i++)
            {
                ...
                {
                    Vector3 characterPosition = GameBoardManagerObject.Positions[TurnManagerObject.characterList[i].PosX, TurnManagerObject.characterList[i].PosY].ToXna();

                    Vector4 v4 = Vector4.Transform(characterPosition + new Vector3(0.0f, 40.0f, 0.0f), mat);
